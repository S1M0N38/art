...
well-formed responses. Results are saved to scripts/generate/tags.json.

Reads API settings from environment variables or a .env file in the project root.
Required env vars: VLM_BASE_API, VLM_MODEL.

Usage:
    uv run scripts/generate/tags.py                                        # all thumbs
    uv run scripts/generate/tags.py images/optimized/thumbs/00cb4951.webp  # single file
